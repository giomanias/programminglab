...
class CSVTimeSeriesFile():
  ...
  def get_data(self):
    ...
    if self.name == None:
      ...
      raise ExamException('inserire un file')
    ...
    for y in range(lungy-1):
      ...
      for m in range(12):
        ...
        data1m = data1.month #mese di data1
...
def compute_avg_monthly_difference(time_series, first_year, last_year):
  ...
  try:
    ...
    raise ExamException('non è un anno')
  ...
  if data_inizio > data_fine:
    ...
    raise ExamException('first_year non può essere maggiore di last_year')
